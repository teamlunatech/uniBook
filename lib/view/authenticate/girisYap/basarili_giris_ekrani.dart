...
class BasariliGirisEkrani extends StatefulWidget {
  const BasariliGirisEkrani({super.key});

  @override
  State<BasariliGirisEkrani> createState() => _BasariliGirisEkraniState();
}

class _BasariliGirisEkraniState extends State<BasariliGirisEkrani> {
  @override
