...
class BasariliIlanSilme extends StatefulWidget {
  const BasariliIlanSilme({super.key});

  @override
  State<BasariliIlanSilme> createState() => _BasariliIlanSilmeState();
}

class _BasariliIlanSilmeState extends State<BasariliIlanSilme> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("İlan Silme Başarılı", style: TextStyle(fontSize: 25),),
              SizedBox(height: MediaQuery.sizeOf(context).height/20,),
              CustomButton(
